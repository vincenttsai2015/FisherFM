# Taken from: https://github.com/HannesStark/dirichlet-flow-matching/blob/main/model/promoter_model.py
from torch import nn
import torch
import numpy as np
from .model import expand_simplex
...
class PromoterModel(nn.Module):
    ...
    def forward(self, x, signal, t):
        ...
        # NOTE: the following is proj onto simplex tangent space, which we do not want
        # we want sphere tangent space (done later in our training)
        if self.mode != "sfm":
